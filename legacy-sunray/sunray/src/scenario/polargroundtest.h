/**
 * Automated unit tests for PolarGround
 *
...
#ifndef _POLAR_GROUND_TEST_H_
#define _POLAR_GROUND_TEST_H_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

// put this at the top of the PolarGroundTest.cpp file to add this 
// specific test suite to the full suite of tests
//CPPUNIT_TEST_SUITE_REGISTRATION(PolarGroundTest);

class PolarGroundTest : public CPPUNIT_NS::TestFixture
{
	// cppunit macros to create a suite of tests
	CPPUNIT_TEST_SUITE(PolarGroundTest);
