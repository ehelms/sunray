/**
 * Automated unit tests for ReflectiveGround
 *
...
// put this at the top of the ReflectiveGroundTest.cpp file to add this 
// specific test suite to the full suite of tests
//CPPUNIT_TEST_SUITE_REGISTRATION(ReflectiveGroundTest);

class ReflectiveGroundTest : public CPPUNIT_NS::TestFixture
{
	// cppunit macros to create a suite of tests
	CPPUNIT_TEST_SUITE(ReflectiveGroundTest);
