...
bool ImportedActor::intersects ( const SolarRay &source, SolarRay &result ) const
{
	GFX::point3d p = source.getOrigin();
	GFX::vector3d v = source.getDirection();
