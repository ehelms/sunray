/**
 * Automated unit tests for FlatGround
 *
...
#ifndef _FLAT_GROUND_TEST_H_
#define _FLAT_GROUND_TEST_H_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

// put this at the top of the FlatGroundTest.cpp file to add this 
// specific test suite to the full suite of tests
//CPPUNIT_TEST_SUITE_REGISTRATION(FlatGroundTest);

class FlatGroundTest : public CPPUNIT_NS::TestFixture
{
	// cppunit macros to create a suite of tests
	CPPUNIT_TEST_SUITE(FlatGroundTest);
