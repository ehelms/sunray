/**
 * Automated unit tests for ImportedActor
 *
...
#ifndef _IMPORTED_ACTOR_TEST_H_
#define _IMPORTED_ACTOR_TEST_H_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

// put this at the top of the ImportedActorTest.cpp file to add this 
// specific test suite to the full suite of tests
//CPPUNIT_TEST_SUITE_REGISTRATION(ImportedActorTest);

class ImportedActorTest : public CPPUNIT_NS::TestFixture
{
	// cppunit macros to create a suite of tests
	CPPUNIT_TEST_SUITE(ImportedActorTest);
